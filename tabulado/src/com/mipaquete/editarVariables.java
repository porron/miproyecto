...
public class editarVariables extends DialogFragment implements
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		final EditText granulado = (EditText) rootView.findViewById(R.id.tgranulado);
		...
		granulado.setText(Double.toString(mivariable.granulado));
						...
						if (spinnerRango.getSelectedItemId() == 1
							...
							if (validarNombre(nombre.getText().toString())
								...
								mivariable.representacion = (int) spinnerRepresentacion
										.getSelectedItemId();
								mivariable.plotlong = Integer.parseInt(plotlong
										.getText().toString());
								mivariable.granulado = Double
										.parseDouble(granulado.getText()
												.toString());
